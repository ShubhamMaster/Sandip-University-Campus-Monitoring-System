...
<div align="center">
    ...
    <video width="550" controls>
        ...
        Your browser does not support the video tag. Open the video directly: <a href="https://shubham.civoranexus.com/images/projects/AI-Powered%20Campus%20Monitoring%20System/gate-in-out.mp4">View video</a>
    </video>
    <p>Live demo</p>
</div>
...
<!-- Start project: -->
Set-Location "d:\Acadmic\College_Projects\Gate Entry Exit Portal\People-Counting-in-Real-Time"; & "C:\Users\SHUBHAM\AppData\Local\Programs\Python\Python313\python.exe" app.py

<!-- Optional single command (restart = stop + start): -->
Set-Location "d:\Acadmic\College_Projects\Gate Entry Exit Portal\People-Counting-in-Real-Time"; Get-Process -Name python* -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue; Start-Sleep -Milliseconds 500; & "C:\Users\SHUBHAM\AppData\Local\Programs\Python\Python313\python.exe" app.py